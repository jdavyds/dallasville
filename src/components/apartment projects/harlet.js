...
export default function Harlet() {
  return (
    <div className={style.cron}>
        ...
        <section className={style.detail}>
                ...
                <div>
                    <h4>Harlet</h4>
                    <p>Harlet By ChaviD Properties is a luxurious 3bedroom Apartment located in the heart of Jahi District Abuja. It’s designed to cater for individuals with premium taste and class. </p>
