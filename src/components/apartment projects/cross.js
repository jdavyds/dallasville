  ...
  return (
    <div className={style.cron}>
        ...
        <section className={style.detail}>
                ...
                <div>
                    <h4>Cross Apartments</h4>
                    <p>Cross Apartments By ChaviD Properties is a luxurious 3bedroom Apartment located in the heart of Jahi District Abuja. It’s designed to cater for individuals with premium taste and class. </p>
